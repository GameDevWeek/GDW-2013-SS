...
public interface INetDatagram {
    ...
    /**
     * @return A unique id, used in combo with type for identifying delta
     *         message bases
     */
    short getID();

    /**
     * @return The first parameter of the header. If the message type is not
     *         none, this contains the message size.
     */
    short getParam1();

    /**
     * @return The second parameter of the header. If the message type is not
