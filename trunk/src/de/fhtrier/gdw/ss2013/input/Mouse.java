...
public class Mouse extends InputDevice {
    ...
    public void update() {
        ...
        if (oldX != container.getInput().getMouseX()
                || oldY != container.getInput().getMouseY()) {
            manager.setCursor(InputAction.TARGET, container.getInput()
    ...
    private void loadSettings() {
        ...
        if (controlsInfo.mouse != null && controlsInfo.mouse.alien != null) {
            ...
            addButton(InputAction.USE_ABILITY,
                    controlsInfo.mouse.alien.USE_ABILITY);
            addButton(InputAction.NEXT_ABILITY,
                    controlsInfo.mouse.alien.NEXT_ABILITY);
            addButton(InputAction.PREV_ABILITY,
                    controlsInfo.mouse.alien.PREV_ABILITY);
        }
    }
