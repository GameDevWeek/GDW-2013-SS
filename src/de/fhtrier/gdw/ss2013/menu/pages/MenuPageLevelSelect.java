...
public class MenuPageLevelSelect extends MenuPage {
	...
	public MenuPageLevelSelect (GameContainer container, StateBasedGame game, MenuManager menuManager, MenuPage parent,
		String bgImage) throws SlickException {
		...
		final ToggleButton tb=addLeftAlignedToggleButton(lvls, 10 + space + 50, yCenter * 0.25f, font, Align.LEFT);
		
		addCenteredButton("GO!", xCenter, yCenter, font, new IActionListener() {
		...
		addCenteredButton("zurück", xCenter, MenuManager.MENU_HEIGHT - 1.5f * textHeight, font, new IActionListener() {
			public void onAction () {
				close();
			}
		});
